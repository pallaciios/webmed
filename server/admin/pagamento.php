...
require_once  '../../app/admin/vendor/autoload.php';

$app = AppFactory::create();

MercadoPago\SDK::setAccessToken($_ENV["TEST-3019589738811004-070401-f494550b03cee9335bfde3358bff73c2-374628797"]);
...
$app->get('/', function (Request $request, Response $response, $args) {
    ...
    $response->getBody()->write($twig->render('index.html', ['public_key' => $_ENV["TEST-27dd4f15-1b71-4189-8d5f-37f07e3caeb2"]]));
    return $response;
});
